...
as well as getting its path from any script in the project.

Useful to import a module from a branch of directories into another branch of directories,
or to work with relative paths starting from the root directory.
"""


def add_root(nested_level=2):
    """
...
def get_root_path(nested_level=2):
    """
